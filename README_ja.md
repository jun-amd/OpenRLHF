...
<a id="amdサポート"></a>
### AMDサポート
OpenRLHFはAMD ROCm GPU（MI300X）上で動作し、ハイブリッドエンジンによるPPO学習をサポートします。コンテナの起動、環境検証、学習例については、[AMD ROCmクイックスタートガイド](./docs/amd_quick_start.md)を参照してください。
